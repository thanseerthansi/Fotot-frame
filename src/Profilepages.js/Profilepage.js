...
export default function Profilepage() {
 ...
 <div className="modal fade" id="modal-order" tabIndex={-1}>
  <div className="modal-dialog modal-dialog-centered modal-sm" style={selectitm.product_type==="College"& selectitm.orientation!=="Portait"?{maxWidth:"900px"}:{}}>
    <div className="modal-content text-center">
      <div className="modal-body">
        ...
        //     :null}</div>
            ...
            {selectitm.image_url ? 
            <div className={"d-flex border-cp framebox-shadow"} style={selectitm.image_url.split(',').length===2?{width:"500px",height:"100%",margin:"auto",borderImage:`url(${imgUrl+selectitm.frame[0]?.image??"/assets/img/photos/collage-black.png"})1%  stretch repeat`}:selectitm.image_url.split(',').length===3?{width:"780px",height:"200px",borderImage:`url(${imgUrl+selectitm.frame[0]?.image??"/assets/img/photos/collage-black.png"})1%  stretch repeat`}:{width:"1049px",height:"200px",borderImage:`url(${imgUrl+selectitm.frame[0]?.image??"/assets/img/photos/collage-black.png"})1%  stretch repeat`}}   >
          ...
          <div className='overflowbar'>
          <div className=" border-cp framebox-shadow" style={{width:"300px",margin:"auto",borderImage:`url(${imgUrl+selectitm.frame[0]?.image??"/assets/img/photos/collage-black.png"})1%  stretch repeat`}}   >
              <DragDropContext >
      <Droppable droppableId="uploaded-images" direction='vertical'>
        ...
        <div className='overflowbar'>
        <div className="border-cp framebox-shadow" style={selectitm.image_url.split(',').length===4? {width:"386px",margin:"auto",padding:"5px",borderImage:`url(${imgUrl+selectitm.frame[0]?.image??"/assets/img/photos/collage-black.png"})1%  stretch repeat`}:selectitm.image_url.split(',').length===9?{width:"505px",margin:"auto",padding:"5px",borderImage:`url(${imgUrl+selectitm.frame[0]?.image??"/assets/img/photos/collage-black.png"})1%  stretch repeat`}:{width:"746px",margin:"auto",padding:"5px",borderImage:`url(${imgUrl+selectitm.frame[0]?.image??"/assets/img/photos/collage-black.png"})1%  stretch repeat`}}   >
    ...
    <div className="App">
      ...
      />
        ...
        <>
            {selectitm.frame? 
            <div className='overflowbar'>
             <div className="d-flex border-cp framebox-shadow" style={{width:"266px",margin:"auto",borderImage:`url(${imgUrl+selectitm.frame[0]?.image??"/assets/img/photos/collage-black.png"})1%  stretch repeat`}} >
            {selectitm.image_url.split(',').length?selectitm.image_url.split(',').map((itm,k)=>(               
    ...
    :selectitm.product?
    <div className={selectitm.frame?' d-flex border-cp framebox-shadow':'d-flex framebox-shadow'} style={selectitm.frame?{width:"335px",height:"100%",margin:"auto",borderImage:`url(${imgUrl+selectitm.frame[0]?.image??"/assets/img/photos/collage-black.png"})1%  stretch repeat`}:{width:"335px",height:"100%",margin:"auto"}}   >
