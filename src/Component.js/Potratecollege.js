    ...
    <div>
        ...
        <div className=" " >
          ...
          <h4>Drag & reorder images</h4>
            ...
            <div className={frame==="Black"?'  border-cp framebox-shadow':frame==="Natural oak"?"d-flex  border-oak-cp framebox-shadow":"d-flex  border-white-cp framebox-shadow"} style={uploaded_images.length===2?{width:"80%",height:"100%",margin:"auto"}:{width:"100%",height:"100%"}}   >
